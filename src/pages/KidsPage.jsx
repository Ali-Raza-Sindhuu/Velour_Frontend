...
import { KIDS_PRODUCTS, KIDS_CATEGORY_FILTERS } from "@/data/kidsProducts";
...
export default function KidsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <CategoryHero
        title="Kids"
        description="Playful, durable pieces made for everyday adventures."
        imageUrl="https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?q=80&w=1600&auto=format&fit=crop"
        breadcrumb={["Home", "Kids"]}
      />
      <FilterSortBar
        filters={KIDS_CATEGORY_FILTERS}
